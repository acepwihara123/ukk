            ...
            <main class="flex-1 p-6 content-main content-scrollable fade-in">
                ...
                <div class="mb-8">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-800">Data Kamera</h2>
                            <p class="text-gray-600 mt-1">Kelola data kamera yang tersedia untuk disewa</p>
                        </div>
                        
                        <div class="mt-4 md:mt-0">
                            <a href="../tambah/kamera.php" class="inline-flex items-center px-4 py-2.5 bg-primary text-white rounded-lg hover:bg-secondary transition hover-lift">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-primary">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-gray-500 text-sm">Total Kamera</p>
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                            ...
                            <div class="mt-2 md:mt-0">
                                <div class="relative">
                                    ...
                                    <input type="text" id="searchInput" placeholder="Cari kamera..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary w-full md:w-64">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="bg-gray-50">
                                    ...
                                    <th class="text-left py-3 px-6 text-gray-600 font-medium">Nama Kamera</th>
                                    ...
                                    <th class="text-left py-3 px-6 text-gray-600 font-medium">Tipe</th>
                            ...
                            <tbody id="tableBody">
                                ...
                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition fade-in">
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Resolusi: <?= htmlspecialchars($row['resolusi']) ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-4 px-6">
                                    ...
                                    <td class="py-4 px-6">
                                        <span class="font-bold text-gray-800">Rp <?= number_format($row['harga_sewa'], 0, ',', '.') ?>.000</span>
                                        <p class="text-xs text-gray-500">/hari</p>
                                    </td>
                                    <td class="py-4 px-6">
                                        <div class="flex space-x-2">
                                            <a href="../edit/kamera.php?id=<?= $row['id'] ?>" class="inline-flex items-center px-3 py-1.5 bg-blue-50 text-primary rounded-md hover:bg-blue-100 transition">
                                ...
                                <tr>
                                    <td colspan="7" class="py-12 text-center">
                                        <div class="text-gray-400">
                                            ...
                                            <p class="text-lg">Belum ada data kamera</p>
                                            <p class="text-sm mt-1">Mulai dengan menambahkan kamera baru</p>
                                            <a href="../tambah/kamera.php" class="inline-flex items-center px-4 py-2 mt-4 bg-primary text-white rounded-lg hover:bg-secondary transition">
                                                <i class="fas fa-plus mr-2"></i>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                        <div class="flex flex-col md:flex-row justify-between items-center">
                            <p class="text-gray-600 text-sm">
                                Menampilkan <span class="font-medium"><?= ($no-1) ?></span> data kamera
                            </p>
                            <div class="mt-2 md:mt-0">
